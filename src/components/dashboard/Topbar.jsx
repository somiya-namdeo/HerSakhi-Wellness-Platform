...
import { getStoredUser, getUserInitials } from '../../utils/userHelpers'
  ...
  return (
    <div className="w-full h-24 px-6 lg:px-10 flex items-center justify-between z-30 sticky top-0 bg-background/80 backdrop-blur-md">
      <div className="ml-14 lg:ml-0">
        <h1 className="text-2xl font-poppins font-bold text-dark">
          {title}
        </h1>
      </div>
      ...
      <div className="flex items-center gap-4 sm:gap-6">
        ...
        <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center text-white shadow-md cursor-pointer transform hover:scale-105 transition-transform font-medium">
          {initials}
        </div>
      </div>
    </div>
